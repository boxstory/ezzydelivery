...
urlpatterns = [
    ...
    path('p2p/pricing/', webpages_views.p2p_pricing, name='p2p_pricing'),
    path('p2p/pricing/resolve-url/', webpages_views.p2p_resolve_url, name='p2p_resolve_url'),
    path('3pl/inquiry/', webpages_views.delivery_inquiry, name='delivery_inquiry'),
    path('3pl/inquiry/quote/<uuid:token>/', webpages_views.inquiry_quote, name='inquiry_quote'),
    path('3pl/inquiry/resume/<uuid:token>/', webpages_views.inquiry_resume, name='inquiry_resume'),
