...
(function() {
    ...
    // Configuration
    const SESSION_TIMEOUT = window.SESSION_TIMEOUT || 3600; // 1 hour in seconds
    const WARNING_TIME = window.SESSION_WARNING_TIME || 300; // 5 minutes before timeout
    ...
    function createWarningModal() {
        const modalHTML = `
            <div id="sessionWarningModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 10000; justify-content: center; align-items: center;">
                <div style="background: white; padding: 2rem; border-radius: 12px; max-width: 500px; box-shadow: 0 10px 40px rgba(0,0,0,0.3); text-align: center;">
                    <div style="font-size: 3rem; color: #ff6b6b; margin-bottom: 1rem;">
                        <i class="fas fa-exclamation-triangle"></i>
                    </div>
                    <h3 style="margin-bottom: 1rem; color: #333;">Session Expiring Soon!</h3>
                    <p style="margin-bottom: 1.5rem; color: #666;">
                        Your session will expire in <strong id="sessionCountdown" style="color: #ff6b6b; font-size: 1.5rem;">5:00</strong>
                        due to inactivity.
                    </p>
                    ...
                    <div style="display: flex; gap: 1rem; justify-content: center;">
                        <button id="stayLoggedInBtn" class="btn btn-primary" style="padding: 0.75rem 2rem;">
                            <i class="fas fa-check-circle me-2"></i>Stay Logged In
                        </button>
                        <button id="logoutNowBtn" class="btn btn-outline-secondary" style="padding: 0.75rem 2rem;">
