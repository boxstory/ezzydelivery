    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seo_title', models.CharField(blank=True, help_text='SEO title (60-70 chars)', max_length=70)),
                ('seo_description', models.CharField(blank=True, help_text='Meta description (150-160 chars)', max_length=160)),
                ('seo_keywords', models.CharField(blank=True, help_text='Comma-separated keywords', max_length=500)),
